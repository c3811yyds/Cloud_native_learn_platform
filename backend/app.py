...
from routes_practice_student import practice_student_bp
...
def create_app():
    ...
    app.config["SQLALCHEMY_DATABASE_URI"] = os.getenv(
        "DATABASE_URL",
        "mysql+pymysql://root:mysql@127.0.0.1:3306/cloud_native_learning_platform?charset=utf8mb4",
    )
    ...
    app.config["REDIS_URL"] = os.getenv("REDIS_URL", "redis://127.0.0.1:6380/0")
    ...
    app.register_blueprint(practice_student_bp)
